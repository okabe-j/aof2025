...
let sample_input_values = String.to_list (In_channel.read_all "/Users/jiamingzhao/Documents/hardcaml/aof2025/test/testcase/day11.txt") @ ['\x04']
...
let simple_testbench (sim : Harness.Sim.t) testfile =
 ...
 let rec get_output n = 
  ...
  (* Give some time to allow RAM initialization *)
  cycle ~n:40000 ();
...
let%expect_test "Day05_Part1" =
  let module Algo_top_day05_part1 = Algo_top.Make (struct
    let day           = "day05"
    let part          = "part1"
    let result_width  = result_width
  end) in 
  Harness.run_advanced ~waves_config ~create:Algo_top_day05_part1.hierarchical simple_testbench "day05.txt";
  [%expect {| (Result (result_number 874)) |}]
;;

let%expect_test "Day05_Part2" =
  let module Algo_top_day05_part2 = Algo_top.Make (struct
    let day           = "day05"
    let part          = "part2"
    let result_width  = result_width
  end) in 
  Harness.run_advanced ~waves_config ~create:Algo_top_day05_part2.hierarchical simple_testbench "day05.txt";
  [%expect {| (Result (result_number 348548952146313)) |}]
;;
...
let%expect_test "Day09_Part1" =
  let module Algo_top_day09_part1 = Algo_top.Make (struct
    let day           = "day09"
    let part          = "part1"
    let result_width  = result_width
  end) in 
  Harness.run_advanced ~waves_config ~create:Algo_top_day09_part1.hierarchical simple_testbench "day09.txt";
  [%expect {| (Result (result_number 4773451098)) |}]
;;

let%expect_test "Day09_Part2" =
  let module Algo_top_day09_part2 = Algo_top.Make (struct
    let day           = "day09"
    let part          = "part2"
    let result_width  = result_width
  end) in 
  Harness.run_advanced ~waves_config ~create:Algo_top_day09_part2.hierarchical simple_testbench "day09.txt";
  [%expect {| (Result (result_number 1429075575)) |}]
;;

let%expect_test "Day10_Part1" =
  let module Algo_top_day10_part1 = Algo_top.Make (struct
    let day           = "day10"
    let part          = "part1"
    let result_width  = result_width
  end) in 
  Harness.run_advanced ~waves_config ~create:Algo_top_day10_part1.hierarchical simple_testbench "day10.txt";
  [%expect {| (Result (result_number 505)) |}]
;;

let%expect_test "Day10_Part2" =
  let module Algo_top_day10_part2 = Algo_top.Make (struct
    let day           = "day10"
    let part          = "part2"
    let result_width  = result_width
  end) in 
  Harness.run_advanced ~waves_config ~create:Algo_top_day10_part2.hierarchical simple_testbench "day10.txt";
  [%expect {| (Result (result_number 20002)) |}]
;;

let%expect_test "Day11_Part1" =
  let module Algo_top_day11_part1 = Algo_top.Make (struct
    let day           = "day11"
    let part          = "part1"
    let result_width  = result_width
  end) in 
  Harness.run_advanced ~waves_config ~create:Algo_top_day11_part1.hierarchical simple_testbench "day11.txt";
  [%expect {| (Result (result_number 599)) |}]
;;

let%expect_test "Day11_Part2" =
  let module Algo_top_day11_part2 = Algo_top.Make (struct
    let day           = "day11"
    let part          = "part2"
    let result_width  = result_width
  end) in 
  Harness.run_advanced ~waves_config ~create:Algo_top_day11_part2.hierarchical simple_testbench "day11.txt";
  [%expect {| (Result (result_number 393474305030400)) |}]
;;
